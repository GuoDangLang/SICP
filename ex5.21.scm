...
(define count-leaves
  (make-machine
    ...
    (list (list '+ +) (list 'pair? pair?) (list 'not not) (list 'null? null?))
    '(count-leaves
      (initialize)
      (assign continue (label count-end))
      count-loop
      (test (op null?) (reg tree))
      (branch (label null-proc))
...
(define count-leaves-n
  (make-machine 
    ...
    '(count-leaves
       ...
       (statistics))))
(set-register-contents! count-leaves-n 'tree (cons 1 2))
