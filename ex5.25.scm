...
(define eceval
  (make-machine
	...
	(op announce-output) (const ";;; EC-Eval value:"))
      ...
      (branch (label ev-appl-operand-comp-loop))
      ...
      ev-appl-operand-comp-loop
      (test (op null?) (reg unev))
      (branch (label ev-appl-operand-comp-end))
      (assign exp (op first-operand) (reg unev))
      (assign exp (op list) (const thunk) (reg exp) (reg env))
      (assign argl (op adjoin-arg) (reg exp) (reg argl))
      (assign unev (op rest-operands) (reg unev))
      (goto (label ev-appl-operand-comp-loop))
      ev-appl-operand-comp-end
      (restore proc)
