;;;b.I don't think so,compilation only need to run once, then everytime you evaluate the object program,you don't need and analysis,but the interpreter needs to "compile" it every time it runs;
;;;a.
(load "5.4.scm")
(load "ex5.19.scm")
