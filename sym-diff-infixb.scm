...
(define (make-sum a1 a2)
  (cond ((=number? a1 0) a2)
	...
	((sum? a1) (if (sum? a2) (append (append a1 (list '+)) a2)
		     (append (append a1 (list '+)) (list a2))))
	(else (if (sum? a2) (append (list a1 '+) a2)
		(list a1 '+ a2)))))
(define (make-product a b)
  (cond ((or (=number? a 0) (=number? b 0)) 0)
	...
	((product? a) (if (product? b) (append (append a (list '*)) b)
			(append (append a (list '*)) (list b))))
	(else (if (product? b) (append (list a '*) b)
		(list a '* b)))))
(define (sum? x)
